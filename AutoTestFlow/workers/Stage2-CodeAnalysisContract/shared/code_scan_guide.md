...
profile 定义位于 `workers/Stage2-CodeAnalysisContract/shared/code_scan_profiles.json`。新增语言时优先扩展 profile，不改变下游 fact schema。
...
使用 `workers/Stage2-CodeAnalysisContract/shared/java_scan_guide.md` 作为 Java/Spring profile 附录。重点信号：
