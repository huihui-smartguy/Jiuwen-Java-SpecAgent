...
> Beta wiki 纪律见 `workers/Stage26-KnowledgeMatch/shared/wiki_rules.md`：wiki **仅 advisory、不作 oracle、不替代 contract 判据**。
>
...
> 红线见 `workers/Stage6-FaultAnalysis/shared/remediation_rules.md`：契约唯一权威、修 SUT 使其符合契约、**绝不弱化测试洗绿**。
