...
deterministically with `workers/Stage0-SutManifest/scripts/sut_manifest.py`, and writes the normalized
...
can be passed through `workers/Stage0-SutManifest/scripts/sut_manifest.py --candidate-manifest <json>` for
...
`workers/Stage0-SutManifest/scripts/sut_manifest.py --sut-manifest <path> --write` produces:
