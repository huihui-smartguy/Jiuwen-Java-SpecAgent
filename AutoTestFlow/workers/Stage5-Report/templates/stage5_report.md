...
> `python {skill_dir}/workers/Stage5-Report/scripts/record_faults.py --output-dir {output_dir}`（默认 dry-run）
...
> `python {skill_dir}/workers/_common/scripts/professional_acceptance.py --output-dir {output_dir} --mode report`
