...
def check_not_matcher_input(repo_root):
    ...
    targets = [
        os.path.join(repo_root, "AutoTestFlow", "workers", "Stage26-KnowledgeMatch", "scripts", "match_faults.py"),
        os.path.join(repo_root, "AutoTestFlow", "workers", "Stage5-Report", "scripts", "record_faults.py"),
    ]
    hits = []
    for t in targets:
