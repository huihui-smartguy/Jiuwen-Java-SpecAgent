...
> Beta wiki 纪律见 `workers/Stage26-KnowledgeMatch/shared/wiki_rules.md`：wiki **仅 advisory、不作 oracle、断言级别仍按 contract 封顶**。
>
...
### 最高红线（与 workers/_common/shared/rules.md §2/§4/§6 一致，违反即任务失败）
