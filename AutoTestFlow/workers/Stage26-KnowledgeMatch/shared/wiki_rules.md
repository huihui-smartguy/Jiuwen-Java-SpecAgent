...
> `workers/_common/shared/rules.md` §4 与 `FaultsAnalysis/07-LLM_Wiki与故障库知识源分析.md` §六护栏。
> `workers/Stage26-KnowledgeMatch/scripts/check_wiki.py` 把以下纪律**逐条变成可执行断言**，离线机械校验。
