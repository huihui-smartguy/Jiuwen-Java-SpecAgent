# F-REQ-004 · body参数格式错误

> 溯源：`rest_api_common_faults.json` → `FC-REQ-001`（请求体缺陷）→ `F-REQ-004`
...
参数格式不符合规范（如日期格式、邮箱格式、UUID格式）

## 怎么触发

传入格式错误的字符串（如非法日期'2024-13-45'）
